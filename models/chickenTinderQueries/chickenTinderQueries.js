...
const getRestaurantsByRoomId = 'SELECT restaurants.id, restaurants.room_number, restaurants.restaurant_name, restaurants.restaurant_image_url, restaurants.rating, restaurants.num_of_yes, room.closed FROM restaurants INNER JOIN room ON room.room_number = restaurants.room_number WHERE room.room_number = ?;';
