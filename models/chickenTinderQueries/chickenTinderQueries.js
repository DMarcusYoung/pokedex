...
const addRestaurant = 'INSERT INTO restaurants (room_number, restaurant_name, restaurant_image_url, rating, city, rest_url) VALUES (?, ?, ?, ?);';
...
const getRestaurantsByRoomId = 'SELECT restaurants.id, restaurants.room_number, restaurants.restaurant_name, restaurants.restaurant_image_url, restaurants.rating, restaurants.num_of_yes, restaurants.city, rest_url, room.closed FROM restaurants INNER JOIN room ON room.room_number = restaurants.room_number WHERE room.room_number = ? GROUP BY restaurants.restaurant_name;';
